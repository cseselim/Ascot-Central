...
add_action( 'wp_enqueue_scripts', 'startup_enqueue_admin_scripts' );
...
wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/scripts/bootstrap.min.js' );
wp_enqueue_script( 'font-awesome-js', get_template_directory_uri() . '/scripts/all.min.js' );
wp_enqueue_script( 'slicknav-js', get_template_directory_uri() . '/scripts/jquery.slicknav.min.js' );
...
function new_nav_menu_items($items, $args) {
    if($args->theme_location == 'main-menu'){
       $shop_item = '<li class="h-search"><a><form>
